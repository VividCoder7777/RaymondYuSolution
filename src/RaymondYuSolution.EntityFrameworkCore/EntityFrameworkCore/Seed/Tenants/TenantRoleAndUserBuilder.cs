...
namespace RaymondYuSolution.EntityFrameworkCore.Seed.Tenants
{
    public class TenantRoleAndUserBuilder
    {
        private readonly RaymondYuSolutionDbContext _context;
        ...
        private void CreateRolesAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new RaymondYuSolutionAuthorizationProvider())
